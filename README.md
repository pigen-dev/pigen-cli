...
# Simple Example 
In [simples](https://github.com/pigen-dev/pigen-cli/tree/main/simples) folder you can find some useful simples to test the tool.

[cloud-run-pipeline](https://github.com/pigen-dev/pigen-cli/tree/main/simples/gcp/cloudrun-pipeline)  is a simple pipeline example to deploy a webapp on cloud run. Read the [README.md](#) file to better understand the example.
